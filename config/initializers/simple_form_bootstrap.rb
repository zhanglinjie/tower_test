...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form_long, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-offset-2 col-sm-4' do |wr|
      wr.wrapper tag: 'div', class: 'checkbox' do |ba|
        ba.use :label_input, class: 'col-sm-4'
      end
  ...
  config.wrapper_mappings = {
    ...
    datetime: :horizontal_form,
    date: :horizontal_form,
    time: :horizontal_form
  }
end
